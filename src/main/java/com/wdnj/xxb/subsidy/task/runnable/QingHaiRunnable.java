 ...
 */
public class QingHaiRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public QingHaiRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("青海", new int[] {2018,2019, 2020}, httpClient,
            ConstantUtil.QINGHAI_PUBLIC_URL, ConstantUtil.QINGHAI_LIST_URL, dir);
    }
}
