 ...
 */
public class XiaMenRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public XiaMenRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("厦门", new int[] {2018,2019,2020}, httpClient,
            ConstantUtil.XIAMEN_PUBLIC_URL, ConstantUtil.XIAMEN_LIST_URL, dir);
    }
}
