 ...
 */
public class ZheJiangRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public ZheJiangRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("浙江",new int[]{2018,2019,2020},httpClient,
            ConstantUtil.ZHEJIANG_PUBLIC_URL,ConstantUtil.ZHEJIANG_LIST_URL, dir);
    }
}
