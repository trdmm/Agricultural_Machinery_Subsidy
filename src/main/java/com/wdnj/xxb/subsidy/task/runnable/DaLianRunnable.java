 ...
 */
public class DaLianRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public DaLianRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("大连", new int[] {2018,2019,2020}, httpClient,
            ConstantUtil.DALIAN_PUBLIC_URL, ConstantUtil.DALIAN_LIST_URL, dir);
    }
}
