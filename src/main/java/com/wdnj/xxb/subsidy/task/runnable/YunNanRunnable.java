 ...
 */
public class YunNanRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public YunNanRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("云南", new int[] {2018, 2019, 2020}, httpClient,
            ConstantUtil.YUNNAN_PUBLIC_URL, ConstantUtil.YUNNAN_LIST_URL, dir);
    }
}
