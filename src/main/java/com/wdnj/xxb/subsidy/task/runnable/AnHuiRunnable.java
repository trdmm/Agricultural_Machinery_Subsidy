 ...
 */
public class AnHuiRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public AnHuiRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("安徽",new int[]{2018,2019,2020},httpClient,
            ConstantUtil.ANHUI_PUBLIC_URL,ConstantUtil.ANHUI_LIST_URL, dir);
    }
}
