 ...
 */
public class QingDaoRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public QingDaoRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("青岛", new int[] {2018,2019,2020}, httpClient,
            ConstantUtil.QINGDAO_PUBLIC_URL, ConstantUtil.QINGDAO_LIST_URL, dir);
    }
}
