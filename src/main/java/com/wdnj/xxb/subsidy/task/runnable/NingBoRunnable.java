 ...
 */
public class NingBoRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public NingBoRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("宁波", new int[] {2019,2020}, httpClient,
            ConstantUtil.NINGBO_PUBLIC_URL, ConstantUtil.NINGBO_LIST_URL, dir);
    }
}
