 ...
 */
public class ShanDongRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public ShanDongRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("山东", new int[] {2018, 2019, 2020}, httpClient,
            ConstantUtil.SHANDONG_PUBLIC_URL, ConstantUtil.SHANDONG_LIST_URL, dir);
    }
}
