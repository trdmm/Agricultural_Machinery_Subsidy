 ...
 */
public class ShangHaiRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public ShangHaiRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("上海",new int[]{2018,2019,2020},httpClient,
            ConstantUtil.SHANGHAI_PUBLIC_URL,ConstantUtil.SHANGHAI_LIST_URL, dir);
    }
}
