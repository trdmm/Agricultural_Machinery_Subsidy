 ...
 */
public class ChongQingRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public ChongQingRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("重庆", new int[] {2018, 2019, 2020}, httpClient,
            ConstantUtil.CHONGQING_PUBLIC_URL, ConstantUtil.CHONGQING_LIST_URL, dir);
    }
}
