 ...
 */
public class ShanXi1Runnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public ShanXi1Runnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("山西",new int[]{2019,2020},httpClient,
            ConstantUtil.SHANXI1_PUBLIC_URL,ConstantUtil.SHANXI1_LIST_URL, dir);
    }
}
