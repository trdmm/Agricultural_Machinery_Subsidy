 ...
 */
public class GanSuRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public GanSuRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("甘肃", new int[] {2019, 2020}, httpClient,
            ConstantUtil.GANSU_PUBLIC_URL, ConstantUtil.GANSU_LIST_URL, dir);
    }
}
