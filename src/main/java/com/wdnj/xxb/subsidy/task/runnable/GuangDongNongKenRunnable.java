 ...
 */
public class GuangDongNongKenRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public GuangDongNongKenRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("广东农垦", new int[] {2018, 2019, 2020}, httpClient,
            ConstantUtil.GUANGDONGNONGKEN_PUBLIC_URL, ConstantUtil.GUANGDONGNONGKEN_LIST_URL, dir);
    }
}
