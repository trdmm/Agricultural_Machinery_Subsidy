 ...
 */
public class HeiLongJiangRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public HeiLongJiangRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("黑龙江", new int[] {2019,2020}, httpClient,
            ConstantUtil.HEILONGJIANG_PUBLIC_URL, ConstantUtil.HEILONGJIANG_LIST_URL, dir);
    }
}
