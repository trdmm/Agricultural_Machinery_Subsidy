 ...
 */
public class JiangXiRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public JiangXiRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("江西", new int[] {2018, 2019, 2020}, httpClient,
            ConstantUtil.JIANGXI_PUBLIC_URL, ConstantUtil.JIANGXI_LIST_URL, dir);
    }
}
