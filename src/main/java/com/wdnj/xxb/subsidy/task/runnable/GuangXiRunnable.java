 ...
 */
public class GuangXiRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public GuangXiRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("广西", new int[] {2018, 2019, 2020}, httpClient,
            ConstantUtil.GUANGXI_PUBLIC_URL, ConstantUtil.GUANGXI_LIST_URL, dir);
    }
}
