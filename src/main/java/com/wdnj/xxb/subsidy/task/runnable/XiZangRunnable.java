 ...
 */
public class XiZangRunnable implements Runnable {
    private final SubsidyHttpClient httpClient;
    private final File dir;

    public XiZangRunnable(SubsidyHttpClient subsidyHttpClient, File dir) {
    ...
    @Override
    public void run() {
        SubsidyCommon.getSubsidy("西藏", new int[] {2020}, httpClient,
            ConstantUtil.XIZANG_PUBLIC_URL, ConstantUtil.XIZANG_LIST_URL, dir);
    }
}
